...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 08-12-2022 a las 22:29:34
...
--
-- Estructura de tabla para la tabla `dbcontenidoredeseduca`
--

CREATE TABLE `dbcontenidoredeseduca` (
  `id` int(11) NOT NULL,
...
--
-- Indices de la tabla `dbcontenidoredeseduca`
--
ALTER TABLE `dbcontenidoredeseduca`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT de la tabla `dbcontenidoredeseduca`
--
ALTER TABLE `dbcontenidoredeseduca`
