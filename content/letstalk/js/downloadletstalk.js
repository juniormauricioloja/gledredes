...
function searchLetsTalk(){
    ...
    var cadena = "aux=searchLetstalk&pais="+pais+"&responsable="+responsable+"&status="+status+"&startDate="+startDate+"&endDate="+endDate;
