...
function searchLetsTalk($pais,$responsable,$status,$startDate,$endDate){
    include "../../../models/conection.php";
    $selectPais="";
    $selectResponsable="";
    $selectStatus = "";
    ...
    $sqlSelect = "SELECT * FROM `dbcontenidoredesletstalk` WHERE `fecha` BETWEEN '".$startDate."' AND '".$endDate."' ".$selectPais." ".$selectResponsable." ".$selectStatus;
    $result = mysqli_query($conection, $sqlSelect);
    return $result;
