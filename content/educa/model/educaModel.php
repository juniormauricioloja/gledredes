...
function consultarRedes($pais)
{
    ...
    $sqlBuscar = "SELECT * FROM dbcontenidoredeseduca WHERE `pais`= '$pais'";
...
{
    include "../../../models/conection.php";
    $sqlBuscar = "SELECT * FROM `dbcontenidoredeseduca` WHERE `id`= '$id';";
    $result = mysqli_query($conection, $sqlBuscar);
...
{
    include "../../../models/conection.php";
    $sqlUpdate = "UPDATE `dbcontenidoredeseduca` SET `comentario`='$comentario', `status`='APROBADO' WHERE `id`='$id'";
...
{
    include "../../../models/conection.php";
    $sqlUpdate = "UPDATE `dbcontenidoredeseduca` SET `status`='EJECUTADO' WHERE `id`='$id'";
    $result = mysqli_query($conection, $sqlUpdate);
...
{
    include "../../../models/conection.php";
    $sqlUpdate = "UPDATE `dbcontenidoredeseduca` SET `status`='EVALUADO' ,`alcance`='$alcance',`megusta`='$meGusta',`compartir`='$compartir', `puntuacion`='$puntuacion' WHERE `id`='$id'";
    $result = mysqli_query($conection, $sqlUpdate);
...
function consultaredes($id){
    include "../../../models/conection.php";
    $sqlSelect = "SELECT * FROM `dbcontenidoredeseduca` WHERE `id`='$id'";
    $result = mysqli_query($conection, $sqlSelect);
    return $result;
}

function searchEduca($pais,$responsable,$status,$startDate,$endDate,$order){
    include "../../../models/conection.php";
    $selectPais="";
    $selectResponsable="";
    $selectStatus = "";
    ...
    $sqlSelect = "SELECT * FROM `dbcontenidoredeseduca` WHERE `fecha` BETWEEN '".$startDate."' AND '".$endDate."' ".$selectPais." ".$selectResponsable." ".$selectStatus." ".$selectOrder;
    $result = mysqli_query($conection, $sqlSelect);
    return $result; 
}
...
function deleteRed($idaux){
    include "../../../models/conection.php";
    $sqlDelete="DELETE FROM `dbcontenidoredeseduca` WHERE `id` = '$idaux'";
