...
function searchEduca($pais,$responsable,$status,$startDate,$endDate){
    include "../../../models/conection.php";
    $selectPais="";
    $selectResponsable="";
    $selectStatus = "";
    ...
    $sqlSelect = "SELECT * FROM `dbcontenidoredeseduca` WHERE `fecha` BETWEEN '".$startDate."' AND '".$endDate."' ".$selectPais." ".$selectResponsable." ".$selectStatus;
    $result = mysqli_query($conection, $sqlSelect);
    return $result;
