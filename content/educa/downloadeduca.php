...
<head>
    ...
    <script src="js/downloadeduca.js" type="text/javascript"></script>
</head>
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <div class="form-row mb-3 justify-content-center">
                                <button class="btn btn-md btn-info " onclick="searchEduca();"><i class="bi bi-binoculars-fill"></i> Buscar</button>
                            </div>
