        ...
        <div class="viewlead">
            <main class="page-content">
                ...
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom viewdiv">
                    <h2 class="h4">Contenido Redes Kaplan Medical <?php echo $stringPais;?></h2>

                    <div class="btn-toolbar mb-2 mb-md-0">
                        <a class="btn btn-sm btn-outline-info" role="button" href="downloadkaplan.php">
