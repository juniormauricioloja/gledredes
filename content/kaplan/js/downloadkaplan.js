...
function searchKaplan(){
    ...
    var cadena = "aux=searchKaplan&pais="+pais+"&responsable="+responsable+"&status="+status+"&startDate="+startDate+"&endDate="+endDate+"&order="+order;

    $.ajax({
        type: "POST",
        url: "controller/kaplanController.php",
        data: cadena,
