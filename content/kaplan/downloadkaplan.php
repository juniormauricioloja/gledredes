...
<head>
    ...
    <script src="js/downloadkaplan.js" type="text/javascript"></script>
</head>
            ...
            <div class="justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                <div class="form-new-lead">
                    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                        <h2 class="h4">Reporte Kaplan Medical</h2>
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <div class="form-row mb-3 justify-content-center">
                                <button class="btn btn-md btn-info " onclick="searchKaplan();"><i class="bi bi-binoculars-fill"></i> Buscar</button>
                            </div>
