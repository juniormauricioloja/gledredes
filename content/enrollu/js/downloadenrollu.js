...
function searchEnrollU(){
    ...
    var cadena = "aux=searchEnrollU&pais="+pais+"&responsable="+responsable+"&status="+status+"&startDate="+startDate+"&endDate="+endDate+"&order="+order;

    $.ajax({
        type: "POST",
        url: "controller/enrolluController.php",
        data: cadena,
