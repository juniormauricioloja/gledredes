            ...
            <main class="page-content">
                ...
                <div class="d-flex  justify-content-between align-items-center pt-3 pb-2 ">
                    ...
                    <div class="mr-auto p-2">
                        <h2 class="h4">Contenido Redes Enroll U <?php echo $stringPais; ?></h2>
                    </div>

                    <div class="d-flex">
                        <div class="btn-toolbar p-2">
                            <a class="btn btn-sm btn-outline-info" role="button" href="downloadenrollu.php">
