...
function consultarRedes($pais)
{
    ...
    $sqlBuscar = "SELECT * FROM dbcontenidoredesenrollu WHERE `pais`= '$pais'";
...
{
    include "../../../models/conection.php";
    $sqlBuscar = "SELECT * FROM `dbcontenidoredesenrollu` WHERE `id`= '$id';";
    $result = mysqli_query($conection, $sqlBuscar);
...
{
    include "../../../models/conection.php";
    $sqlUpdate = "UPDATE `dbcontenidoredesenrollu` SET `comentario`='$comentario', `status`='APROBADO' WHERE `id`='$id'";
...
{
    include "../../../models/conection.php";
    $sqlUpdate = "UPDATE `dbcontenidoredesenrollu` SET `status`='EJECUTADO' WHERE `id`='$id'";
    $result = mysqli_query($conection, $sqlUpdate);
...
{
    include "../../../models/conection.php";
    $sqlUpdate = "UPDATE `dbcontenidoredesenrollu` SET `status`='EVALUADO' ,`alcance`='$alcance',`megusta`='$meGusta',`compartir`='$compartir', `puntuacion`='$puntuacion' WHERE `id`='$id'";
    $result = mysqli_query($conection, $sqlUpdate);
...
,$linkrrss, $linkweb, $linkform, $linkyoutube, $arte, $comentario, $responsable, $alcance, $megusta, $compartir, $puntuacion){
    ...
    include "../../../models/conection.php";
    $sqlUpdate = "UPDATE `dbcontenidoredesenrollu` SET `year`='$year',`mes`='$mes',`semana`='$semana',`fecha`='$fecha',
...
function consultaredes($id){
    include "../../../models/conection.php";
    $sqlSelect = "SELECT * FROM `dbcontenidoredesenrollu` WHERE `id`='$id'";
...
function deleteRed($idaux){
    include "../../../models/conection.php";
    $sqlDelete="DELETE FROM `dbcontenidoredesenrollu` WHERE `id` = '$idaux'";
