<?php
include "../model/enrolluModel.php";
        ...
        ?>
          <td>
            <table>
              ...
              <td>
                <form action="editenrollu.php" method="POST">
...
if($aux == "searchEnrollU")
{
  ...
  $order = $_POST["order"];
  $listaPerfiles = searchEnrollU($pais,$responsable,$status,$startDate,$endDate,$order);
  ?>
    <table class="display table table-hover table-striped" style="width: 100%;" id="tableRedes">
      <thead>
