...
,$linkrrss, $linkweb, $linkform, $linkyoutube, $arte, $comentario, $responsable, $alcance, $megusta, $compartir, $puntuacion, $topico){
    ...
    include "../../../models/conection.php";
    $sqlUpdate = "UPDATE `dbcontenidoredesupper` SET `semana`='$semana',`fecha`='$fecha',
...
function consultaredes($id){
    include "../../../models/conection.php";
    $sqlSelect = "SELECT * FROM `dbcontenidoredesupper` WHERE `id`='$id'";
    $result = mysqli_query($conection, $sqlSelect);
    return $result;
}

function searchUpper($pais,$responsable,$status,$startDate,$endDate,$order){
    include "../../../models/conection.php";
    $selectPais="";
    $selectResponsable="";
    $selectStatus = "";
    ...
    $sqlSelect = "SELECT * FROM `dbcontenidoredesupper` WHERE `fecha` BETWEEN '".$startDate."' AND '".$endDate."' ".$selectPais." ".$selectResponsable." ".$selectStatus." ".$selectOrder;
    $result = mysqli_query($conection, $sqlSelect);
    return $result;
