...
function searchGled($pais,$responsable,$status,$startDate,$endDate){
    include "../../../models/conection.php";
    $selectPais="";
    $selectResponsable="";
    $selectStatus = "";
    ...
    $sqlSelect = "SELECT * FROM `dbcontenidoredesgled` WHERE `fecha` BETWEEN '".$startDate."' AND '".$endDate."' ".$selectPais." ".$selectResponsable." ".$selectStatus;
    $result = mysqli_query($conection, $sqlSelect);
    return $result;
