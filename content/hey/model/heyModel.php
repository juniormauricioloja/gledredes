...
function consultarRedes($pais)
{
    ...
    $sqlBuscar = "SELECT * FROM dbcontenidoredeshey WHERE `pais`= '$pais'";
...
{
    include "../../../models/conection.php";
    $sqlUpdate = "UPDATE dbcontenidoredeshey SET `comentario`='$comentario', `status`='APROBADO' WHERE `id`='$id'";
...
{
    include "../../../models/conection.php";
    $sqlUpdate = "UPDATE dbcontenidoredeshey SET `status`='EJECUTADO' WHERE `id`='$id'";
    $result = mysqli_query($conection, $sqlUpdate);
...
{
    include "../../../models/conection.php";
    $sqlUpdate = "UPDATE dbcontenidoredeshey SET `status`='EVALUADO' ,`alcance`='$alcance',`megusta`='$meGusta',`compartir`='$compartir', `puntuacion`='$puntuacion' WHERE `id`='$id'";
    $result = mysqli_query($conection, $sqlUpdate);
...
,$linkrrss, $linkweb, $linkform, $linkyoutube, $arte, $comentario, $responsable, $alcance, $megusta, $compartir, $puntuacion){
    ...
    include "../../../models/conection.php";
    $sqlUpdate = "UPDATE dbcontenidoredeshey SET `year`='$year',`mes`='$mes',`semana`='$semana',`fecha`='$fecha',
...
function consultaredes($id){
    include "../../../models/conection.php";
    $sqlSelect = "SELECT * FROM dbcontenidoredeshey WHERE `id`='$id'";
    $result = mysqli_query($conection, $sqlSelect);
    return $result;
}

function searchHey($pais,$responsable,$status,$startDate,$endDate,$order){
    include "../../../models/conection.php";
    $selectPais="";
    $selectResponsable="";
    $selectStatus = "";
    ...
    $sqlSelect = "SELECT * FROM `dbcontenidoredeshey` WHERE `fecha` BETWEEN '".$startDate."' AND '".$endDate."' ".$selectPais." ".$selectResponsable." ".$selectStatus." ".$selectOrder;
    $result = mysqli_query($conection, $sqlSelect);
    return $result;
}
...
function deleteRed($idaux){
    include "../../../models/conection.php";
    $sqlDelete="DELETE FROM `dbcontenidoredeshey` WHERE `id` = '$idaux'";
